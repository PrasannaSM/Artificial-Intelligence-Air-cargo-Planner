...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        # node_a1_having = node_a1.action.effect_add
        # node_a1_remove = node_a1.action.effect_rem

        # node_a2_having = node_a2.action.effect_add
        # node_a2_remove = node_a1.action.effect_rem

        # for l in node_a1_having:
        #     if l in node_a2_remove:
        #         return True

        # for l in node_a2_having:
        #     if l in node_a1_remove:
        #         return True
        for a1 in node_a1.effnodes :
            for a2 in node_a2.effnodes :
                if self.negation_mutex(a1,a2) :
                    return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        # node_a1_having = node_a1.action.effect_add
        # node_a1_remove = node_a1.action.effect_rem
        # node_a1_pos = node_a1.action.precond_pos
        # node_a1_neg = node_a1.action.precond_neg
        
        # node_a2_having = node_a2.action.effect_add
        # node_a2_remove = node_a2.action.effect_rem
        # node_a2_pos = node_a2.action.precond_pos
        # node_a2_neg = node_a2.action.precond_neg
        ...
        # for l in node_a2_remove:
        #     if l in node_a1_pos:
        #         return True
        for a1_pos in node_a1.prenodes :
            for a2_neg in node_a2.effnodes :
                if self.negation_mutex(a1_pos,a2_neg):
                    return True
        for a1_neg in node_a1.effnodes :
            for a2_pos in node_a2.prenodes :
                if self.negation_mutex(a1_neg,a2_pos):
                    return True
    ...
    def competing_needs_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        action_s1 = node_a1.parents
        action_s2 = node_a2.parents

        #return True if [(a_s1, a_s2) for a_s1 in actions_s1 for a_s2 in actions_s2 if a_s1.is_mutex(a_s2)]
        for a_s1 in action_s1:
            for a_s2 in action_s2:
    ...
    def inconsistent_support_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s):
        ...
        :return: bool
        """
        action_s1 = node_s1.parents
        action_s2 = node_s2.parents
        
        # TODO test for Inconsistent Support between nodes
        #if not [(a_s1, a_s2) for a_s1 in action_s1 for a_s2 in action_s2 if not a_s1.is_mutex(a_s2)]
        for a_s1 in action_s1:
            for a_s2 in action_s2:
    ...
    def h_levelsum(self) -> int:
        ...
        #     level = 0
        #     while not found:
        #         node_s_list = self.s_levels[level]
        #         literal_list = [node_s.literal for node_s in node_s_list]
        #         if goal in literal_list:
        #             found = True
        #         else:
        #             level += 1
        level_sum = 0
